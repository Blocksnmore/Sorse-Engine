...
const getHexFromName = function (color: string): string {
	return getColorFromName(color).value;
};

const getColorFromCssName = function (name: string): color {
	name = name.trim().toLowerCase();
	return cssColors.filter((color) => color.name.toLowerCase() === name).pop();
};

const getColorFromVgaName = function (name: string): color {
	name = name.trim().toLowerCase();
	return vgaColors.filter((color) => color.name.toLowerCase() === name).pop();
};

const getColorFromName = function (name: string): color {
	name = name || '';
	name = name.trim().toLowerCase();
